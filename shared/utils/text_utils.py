...
CANONICAL_SKILLS: List[str] = [
    ...
    "perl", "lua", "haskell", "erlang", "elixir", "clojure", "dart", "groovy",
    "fortran", "cobol", "assembly", "vba", "bash", "powershell", "shell script",
    # Web Frameworks
    "react", "angular", "vue", "next.js", "nuxt.js", "svelte", "ember", "backbone",
    "django", "flask", "fastapi", "spring", "spring boot", "express", "nest.js",
    "rails", "laravel", "asp.net", "blazor", "htmx", "tailwind", "bootstrap",
    # Data & ML Frameworks
    "tensorflow", "pytorch", "keras", "scikit-learn", "xgboost", "lightgbm",
    "catboost", "hugging face", "transformers", "langchain", "llama", "openai",
    "anthropic", "pandas", "numpy", "scipy", "matplotlib", "seaborn", "plotly",
    "polars", "dask", "ray", "spark", "pyspark", "hadoop", "hive", "flink",
    # Databases
    "postgresql", "mysql", "sqlite", "oracle", "sql server", "mongodb", "redis",
    "elasticsearch", "cassandra", "dynamodb", "neo4j", "influxdb", "clickhouse",
    "snowflake", "bigquery", "redshift", "databricks", "duckdb", "pinecone",
    ...
    "circleci", "argocd", "helm", "prometheus", "grafana", "datadog", "splunk",
    "nginx", "apache", "istio", "envoy", "vault",
    # MLOps & Data Engineering
    "mlflow", "kubeflow", "airflow", "prefect", "dagster", "dbt", "great expectations",
    "feast", "bentoml", "seldon", "triton", "sagemaker", "vertex ai", "azure ml",
    "wandb", "neptune", "comet", "label studio", "dvc",
    # AI / ML Concepts
    "machine learning", "deep learning", "natural language processing", "nlp",
    "computer vision", "reinforcement learning", "generative ai", "llm",
    "large language model", "retrieval augmented generation", "rag",
    "transfer learning", "fine-tuning", "prompt engineering", "embeddings",
    "vector database", "semantic search", "object detection", "image segmentation",
    "speech recognition", "recommendation systems", "time series", "anomaly detection",
    "graph neural networks", "gnn", "transformers", "bert", "gpt", "attention",
    "convolutional neural network", "cnn", "recurrent neural network", "rnn",
    "lstm", "gan", "variational autoencoder", "diffusion models", "stable diffusion",
    "feature engineering", "hyperparameter tuning", "cross-validation",
    "a/b testing", "statistical modeling", "bayesian inference",
    # Software Engineering
    "microservices", "rest api", "graphql", "grpc", "websocket", "kafka",
    "rabbitmq", "sqs", "event-driven architecture", "cqrs", "domain driven design",
    "ddd", "clean architecture", "solid principles", "design patterns",
    "test-driven development", "tdd", "bdd", "agile", "scrum", "kanban",
    "ci/cd", "devops", "sre", "system design", "distributed systems",
    "high availability", "load balancing", "caching", "cdn", "api gateway",
    "oauth", "jwt", "saml", "openid", "cryptography", "security",
    # Data Science
    "data analysis", "data visualization", "business intelligence", "tableau",
    "power bi", "looker", "metabase", "data warehousing", "etl", "elt",
    "data pipeline", "data modeling", "statistics", "probability",
    "regression", "classification", "clustering", "dimensionality reduction",
    "pca", "tsne", "umap", "feature selection", "data cleaning", "eda",
    # Business & Soft Skills
    "product management", "project management", "stakeholder management",
    "technical writing", "documentation", "communication", "leadership",
    "team management", "mentoring", "hiring", "recruitment",
    "budget management", "roadmap planning", "okr", "kpi",
    # Version Control & Tools
    "git", "github", "gitlab", "bitbucket", "jira", "confluence", "slack",
    "linear", "notion", "figma", "postman", "swagger", "openapi",
    # Mobile
    "android", "ios", "react native", "flutter", "xamarin", "ionic",
    # Emerging
    "blockchain", "web3", "solidity", "smart contracts", "nft",
    "ar/vr", "unity", "unreal engine", "edge computing", "iot",
    "quantum computing", "robotics", "ros",
]
...
_STOPWORDS: set[str] = {
    ...
    "he", "she", "they", "us", "our", "their", "my", "your", "his", "her",
...
_SENIORITY_PATTERNS = [
    ...
    ("principal", re.compile(
        r"\b(principal|distinguished|staff|fellow|director|"
        r"vice\s+president|vp)\b",
        re.IGNORECASE
    )),
    ("senior", re.compile(
        r"\b(senior|sr\.|lead|head\s+of|architect|manager|"
        r"engineering\s+manager|em)\b",
        re.IGNORECASE
    )),
    ("junior", re.compile(
        r"\b(junior|jr\.|associate\s+(?:engineer|developer|analyst))\b",
        re.IGNORECASE
    )),
    ("entry", re.compile(
        r"\b(intern|trainee|graduate|fresher|entry[\s-]level|"
        r"entry\s+level)\b",
        re.IGNORECASE
    )),
    ("mid", re.compile(
        r"\b(engineer|developer|analyst|specialist|consultant|"
        r"programmer|scientist)\b",
        re.IGNORECASE
    )),
]
...
_EXP_PATTERNS = [
    ...
    re.compile(r"(\d+(?:\.\d+)?)\s*(?:years?|yrs?)\s*(?:of\s+)?(?:exp(?:erience)?)?", re.IGNORECASE),
