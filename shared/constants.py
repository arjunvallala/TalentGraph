...
REQUIRED_PROFILE_FIELDS = [
    "name", "current_title", "work_experience", "skills",
    "education", "summary",
]
OPTIONAL_PROFILE_FIELDS = [
    "email", "phone", "location", "certifications",
    "languages", "redrob_signals",
]

# ── Seniority Mappings ────────────────────────────────────────────────────────
SENIORITY_KEYWORDS: dict[str, list[str]] = {
    "executive":  ["CEO", "CTO", "CIO", "CFO", "COO", "CISO", "CPO", "President",
                   "EVP", "SVP", "C-Suite"],
    "principal":  ["Principal", "Distinguished", "Fellow", "Staff", "VP", "Vice President",
                   "Director"],
...
LEADERSHIP_STRONG_KEYWORDS = [
    "managed", "led", "directed", "headed", "supervised", "mentored",
    "built team", "hired", "reporting to me", "team of", "team size",
]
LEADERSHIP_MODERATE_KEYWORDS = [
    "collaborated", "coordinated", "guided", "facilitated",
    "cross-functional", "stakeholder",
]

# ── Research Keywords ─────────────────────────────────────────────────────────
RESEARCH_KEYWORDS = [
    "published", "paper", "research", "journal", "conference", "IEEE",
    "ACM", "arxiv", "patent", "patented", "inventor", "github.com",
...
SUBMISSION_COLUMNS = ["candidate_id", "rank", "overall_score",
