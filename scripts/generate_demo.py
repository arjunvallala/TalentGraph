...
SKILL_POOL = {
    "machine learning": ["python", "pytorch", "tensorflow", "scikit-learn", "xgboost", "transformers", "pandas", "numpy", "keras", "hugging face"],
    "backend": ["python", "fastapi", "django", "postgresql", "redis", "docker", "apis", "mongodb", "mysql", "node.js", "go", "java", "spring boot"],
    "frontend": ["react", "typescript", "javascript", "tailwind", "next.js", "html", "css", "vue", "angular", "sass"],
    "devops": ["aws", "docker", "kubernetes", "terraform", "ci/cd", "jenkins", "gcp", "azure", "ansible", "linux", "bash"],
    "data engineering": ["python", "spark", "hadoop", "kafka", "etl", "airflow", "snowflake", "redshift", "sql", "hive"],
}

COMPANIES = ["TCS", "Infosys", "Wipro", "Flipkart", "Swiggy", "Zomato", "CRED", "Razorpay", "Ola", "Paytm", "Freshworks", "Zoho"]
UNIVERSITIES = ["IIT Bombay", "IIT Delhi", "IIT Madras", "BITS Pilani", "IIIT Hyderabad", "Delhi University", "Anna University", "VIT", "NIT Trichy"]
DEGREES = [("B.Tech", "Computer Science"), ("M.Tech", "Data Science"), ("B.Sc", "Information Technology"), ("MCA", "Computer Applications"), ("PhD", "Machine Learning")]

TITLES = {
    "machine learning": ["ML Engineer", "Data Scientist", "Computer Vision Engineer", "NLP Researcher", "AI Engineer"],
    "backend": ["Backend Developer", "Software Engineer - Backend", "API Developer", "Systems Engineer"],
    "frontend": ["Frontend Engineer", "UI Developer", "React Developer", "Web Developer"],
    "devops": ["DevOps Engineer", "Cloud Architect", "Site Reliability Engineer", "Platform Engineer"],
    "data engineering": ["Data Engineer", "ETL Developer", "Data Platform Engineer", "Big Data Developer"],
}
...
def generate_candidate(cid_num: int) -> dict:
    ...
    for i in range(num_jobs):
        ...
        work_history.append({
            ...
            "title": f"Senior {random.choice(TITLES[domain])}" if i == 0 and yoe >= 5.0 else random.choice(TITLES[domain]),
    ...
    return {
        ...
        "availability_status": random.choice(["immediately_available", "notice_period", "open_to_opportunities"]),
